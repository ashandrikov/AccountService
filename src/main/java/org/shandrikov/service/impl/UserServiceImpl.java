...
import org.shandrikov.util.mapper.UserMapper;
...
public class UserServiceImpl implements UserDetailsService, UserService {
    ...
    //It's better to use database here but for test purposes in pet project I've decided to simplify it
    ...
    public void updatePassword(User user, @Valid PasswordDTO passwordDTO) {
        User userByEmail = userRepository.findByEmail(user.getUsername()).get();
        ...
        if (hackedPasswords.contains(newPassword)) {
            ...
            securityEventsService.registerEvent(EventAction.CHANGE_PASSWORD, user.getUsername(), user.getUsername(), "/api/admin/user");
